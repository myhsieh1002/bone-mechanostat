...
MATLAB R2026a ｜ 計畫書：[PROJECT_PLAN_bone_mechanostat.md](PROJECT_PLAN_bone_mechanostat.md)（v2.9）
...
| **P5g** | 重擬 `delta_ab` | ✅ **完成**（72 測試，附錄 C20）：修掉目標函數的腔室範疇錯誤，**V8=12.51% 首次真正達標**；V10 診斷為時間尺度問題 |
| P7 | 論文 | 🔄 敘事已定調（v2.5，附錄 C16）：P1✅／P2✅／**P3❌ 如實入主論文** |

**M1–M8 全模型可跑並已校正，含雙腔室、小樑腔室與分歧分析；72/72 測試通過。** `rhsFull` 串起完整訊號鏈：
...
- [ ] **P5h**：加 romosozumab 停藥反彈機制達成 V10 —— **目前唯一仍未達的定量標的**。已診斷為時間尺度問題（模型 2.85 年達峰、慢約 5 倍），非 `lambda_S`/`K_L` 可解
