...
**版本**：v1.6｜**日期**：2026-07-24｜**實作語言**：MATLAB (R2026a)｜**執行者**：Claude Code
...
| | ⚠️ **v1.6 更正** | **不可由 M3 通道產生**（劑量對 N 漸近線性，見附錄 C6.3）。須由下游飽和解釋，與 V5 共用同一未檢定假說 | | **P3 優先檢定** |
