...
two    = stateVector("two");
verifyEqual(tc, single.n, 17, "Single-compartment model should have 17 states (13 local + 4 systemic; v2.10).");
verifyEqual(tc, two.n, 30, "Two-compartment model should have 30 states (13x2 + 4; v2.10).");
