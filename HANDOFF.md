...
**接手者請先讀這份，再讀 `PROJECT_PLAN_bone_mechanostat.md`（v2.13，含附錄 C1–C24）與 `README.zh-TW.md`（中文工作版；`README.md` 為對外英文版）。**
...
**V1、V2、V3、V7、V8、V10、V16**

- **V8 / V10 / V16 優先** —— 牽涉小樑腔室與停藥反彈，是全篇最新、最少被複核的部分。
- 特別留意 **V10**：判準只是「< 0」（方向），但稿件把 −13.97 % 講成「重現臨床上的快速流失」；治療期增益是 +12.50 %，所以模型其實跌破基線約 1.5 %，而臨床上停藥後多是**回到**基線附近。這正是「把部分成立寫成成立」那一類。
- **V3** 的 48.8 % 沒有判準也沒有引註。
- 皮質 vs 小樑的 **5.1 倍放大**沒有對照任何實證數字（臨床腰椎 vs 全髖約 1.9 倍，但我們的皮質腔室是骨幹不是全髖，本來就不可直接比 —— 要把這點寫出來）。
