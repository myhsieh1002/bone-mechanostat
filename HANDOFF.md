...
**接手者請先讀這份，再讀 `PROJECT_PLAN_bone_mechanostat.md`（v2.10，含附錄 C1–C21）與 `README.md`。**
...
版本推進 v2.4 → **v2.10**，測試 61 → **79**，新增附錄 **C16–C21**。各項定論：
...
**現況：V1–V16 中僅 V6e（髓腔方向，M7 的 `r_e` 缺口）與 V5b（骨層級符號，待 Fu 2025）未達。**

**下一步候選**（無單一明顯最高價值項，請與使用者確認）：抗體 PK（現為階躍，C21.6）｜M7 的 `r_e` 對負荷反應（V6e）｜Sobol/LHS 全域靈敏度｜P5f bedrest 長期崩潰｜P7 論文撰寫。
...
*Handoff 撰於 2026-07-26｜v2.4/61 測試（Opus 4.8）→ **v2.10/79 測試、附錄 C16–C21**（Opus 5，同日 A/B/D/C 四項 + P5g + P5h）*
