...
稿件停在 **v2.14** 的數字。之後 P5l（`nu_E` 1.0→2.55）與 P5m（`kappa_E` 皮質 3.13／小樑 2.00）又動了一輪，須再對帳一次：

| | 稿件現值 | **v2.17** |
|---|---|---|
| d ln ε/d ln f_bm | −2.5000 | **皮質 −3.13、小樑 −2.00**（且須說明兩腔室不同） |
| 小樑 E_app | 99.8 MPa | **288.0 MPa** |
...
⚠️ **一句話現在是錯的**：稿件寫「The elastic law therefore holds across two orders of magnitude of porosity **without adjustment**」。P5m 之後指數是**依腔室而異**的，這句必須改寫（見 C29.4）。
